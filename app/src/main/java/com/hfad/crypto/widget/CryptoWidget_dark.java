...
public class CryptoWidget_dark extends AppWidgetProvider {
    RemoteViews views;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (CLICK_TAG.equals(intent.getAction())){
            ...
            int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, CryptoWidget_dark.class));
    ...
    void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views = new RemoteViews(context.getPackageName(), R.layout.crypto_widget_dark);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.crypto_widget_dark);
